...
class MainWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        save_button.setToolTip("Save any changes for the currently selected item (Ctrl+S).")
        save_button.setStyleSheet("padding: 4px 8px;")
        save_button.clicked.connect(self.save_current_item_changes)
        text_toolbar.addWidget(save_button)
